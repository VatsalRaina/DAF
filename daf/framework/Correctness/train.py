...
parser.add_argument('--n_epochs', type=int, default=3, help='Specify the number of epochs to train for')
...
def main(args):
    ...
    tokenizer = ElectraTokenizer.from_pretrained(electra_large, do_lower_case=True, truncation_side='left')
